...
describe('Message Store', () => {
  ...
  const mockMessage: Omit<MessageState, 'timestamp' | 'metadata'> = {
    type: 'testMessage',
    payload: { data: 'test' },
  ...
  describe('Action Creators', () => {
    ...
    test('should create setFilters action', () => {
      const filters = { types: ['testType'], statuses: ['success'] as const };
  ...
  describe('Reducer', () => {
    ...
    test('should return initial state', () => {
      const state = messageStoreReducer(undefined, { type: 'UNKNOWN', payload: {} } as any);
    ...
    test('should handle ADD_MESSAGE without advancing index during time travel', () => {
      ...
      const action = messageStoreActions.addMessage(
        { ...mockMessage, correlationId: 'new-message' },
        mockMetadata
      );
    ...
    test('should handle UPDATE_MESSAGE_STATUS for existing message', () => {
      ...
      const action = messageStoreActions.updateMessageStatus(
        'test-correlation-id',
        'success',
        { result: 'ok' }
      );
    ...
    test('should handle TIME_TRAVEL_TO with valid index', () => {
      const stateWithMessages = {
        ...
        messages: [
          { ...mockMessage, timestamp: 1234567890, metadata: mockMetadata } as MessageState,
          { ...mockMessage, correlationId: 'msg-2', timestamp: 1234567891, metadata: mockMetadata } as MessageState
        ],
        currentIndex: 1
      };
  ...
  describe('Selectors', () => {
    const stateWithMessages: MessageStoreState = {
      messages: [
        {
          type: 'message1',
          payload: { data: 'test1' },
  ...
  describe('MessageStore Class', () => {
    ...
    describe('State Management', () => {
      ...
      test('should not notify listeners if state unchanged', () => {
        ...
        store.dispatch({ type: 'UNKNOWN_ACTION', payload: {} } as any);

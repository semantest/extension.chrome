...
export class GoogleImagesContentAdapter extends Adapter {
    private downloader: GoogleImagesDownloader;
    private isGoogleImagesPage: boolean = false;
    private downloadButtons = new Map<HTMLImageElement, HTMLButtonElement>();
     ...
     */
    private detectGoogleImagesPage(): boolean {
     ...
     */
    private addDownloadButtonsToImages(): void {
     ...
     */
    private addDownloadButton(img: HTMLImageElement): void {
     ...
     */
    private createImageContainer(img: HTMLImageElement): HTMLDivElement {
     ...
     */
    private createDownloadButton(img: HTMLImageElement): HTMLButtonElement {
     ...
     */
    private positionDownloadButton(img: HTMLImageElement, container: HTMLElement): void {
     ...
     */
    private addContextMenuHandlers(): void {
     ...
     */
    private isGoogleImage(img: HTMLImageElement): boolean {
     ...
     */
    private showCustomContextMenu(e: MouseEvent, img: HTMLImageElement): void {
        e.preventDefault();
     ...
     */
    private findHoveredImage(): HTMLImageElement | null {
     ...
     */
    private async handleImageDownload(img: HTMLImageElement): Promise<void> {
        try {
     ...
     */
    private showDownloadFeedback(img: HTMLImageElement, message: string, isError: boolean = false): void {
